 ...
 */
public class MyFinalExamResultsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyFinalExamResultsAdapter(Fragment screen, int position, List<ExamResult> examResults) {
        this.screen = screen;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyFinalExamResultsAdapterViewHolder viewHolder = new MyFinalExamResultsAdapterViewHolder(view, viewType);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        try {
            if (holder instanceof MyFinalExamResultsAdapterViewHolder) {
                MyFinalExamResultsAdapterViewHolder semesterHolder = (MyFinalExamResultsAdapterViewHolder) holder;
...
//                //Define and set data
    ...
    public class MyFinalExamResultsAdapterViewHolder extends RecyclerView.ViewHolder {
        View view;
        int viewType;

        public MyFinalExamResultsAdapterViewHolder(View itemView, int viewType) {
            super(itemView);
            this.view = itemView;
