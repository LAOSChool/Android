...
public class Message {
    ...
    public static abstract class MessageColumns implements BaseColumns {
        ...
        public static final int COLUMN_NAME_IS_READ_INDEX_11 = 11;

        public static final int COLUMN_NAME_SENT_DT_INDEX_12 = 12;
        public static final int COLUMN_NAME_READ_DT_INDEX_13 = 13;

        public static final int COLUMN_NAME_IMP_FLG_INDEX_14 = 14;

        public static final int COLUMN_NAME_OTHER_INDEX_15 = 15;
        public static final int COLUMN_NAME_TITLE_INDEX_16 = 16;
        ...
        public static final String CREATE_MESSAGES_TABLE =  "CREATE TABLE " + TABLE_NAME + "("
                ...
                + COLUMN_NAME_TITLE + " TEXT,"//1
                + COLUMN_NAME_SCHOOL_ID + " INTEGER,"//2
                + COLUMN_NAME_CLASS_ID + " INTEGER,"//3

                + COLUMN_NAME_FROM_USR_ID + " INTEGER,"//4
                + COLUMN_NAME_FROM_USER_NAME + " TEXT,"//5

                + COLUMN_NAME_TO_USR_ID + " INTEGER,"//6
                + COLUMN_NAME_TO_USER_NAME + " TEXT,"//7

                + COLUMN_NAME_CONTENT + " TEXT,"//8
                + COLUMN_NAME_MSG_TYPE_ID + " INTEGER,"//9

                + COLUMN_NAME_CHANNEL + " INTEGER,"//10

                + COLUMN_NAME_IS_SENT + " INTEGER,"//11
                + COLUMN_NAME_SENT_DT + " TEXT,"//12
                + COLUMN_NAME_IS_READ + " INTEGER,"//13

                + COLUMN_NAME_READ_DT + " TEXT,"//14
                + COLUMN_NAME_IMP_FLG + " INTEGER,"//15
